...
export const Hero = () => {
  return (
    ...
    >
      {/* gradient bg of section */}
      <div className="absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255.5)_15%,rgb(14,0,36,.5)_78%,transparent)]"></div>
      {/*start planet */}
      <div className="absolute h-64 w-64 md:h-96 md:w-96 bg-purple-500 border border-white/20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,rgb(184,148,255)_37.7%,rgb(24,0,66))] shadow-[-20px_-20px_50px_rgb(255,255,255,.5),_-20px_-20px_80px_rgb(255,255,255,.1),0_0_50px_rgb(140,69,255)]"></div>
      {/* end planet */}
      {/* first ring */}
      ...
      {/* third rang */}
      <div className="absolute h-[544px] w-[544px] md:h-[880px] md:w-[880px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full"></div>
      ...
      <div className="container relative mt-20">
        ...
        <p className="text-lg md:text-xl  max-w-xl mx-auto mt-5 text-white/70 text-center">
